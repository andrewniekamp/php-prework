...
<body>
    ...
    <p>"<?php echo $exclamation; ?>," <?php echo $person2; ?> cried. </p>
    <p>The two of them <?php echo $verb; ?> as quickly possible, and when they were safe, <?php echo $person1; ?> and <?php echo $person2; ?> found a <?php echo $noun; ?>.<p>
</body>
</html>